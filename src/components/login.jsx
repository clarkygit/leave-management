...
function submitBtn(e){
    ...
    document.getElementById("password").value = "typedEmail";    
}
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                        <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                            ...
                            <form onSubmit={submitBtn} method="POST" class="mt-8">
                                <div class="space-y-5">
                                    <div>
                                    ...
                                    <div>
                                        <button id="submitBtn" type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700">Log in</button>
                                    </div>
                                </div>
                            </form>
